...
//   const invoices = await fetchFilteredInvoices(query, currentPage);
  const services = [{'id': '1', 'name': 'Troca de óleo', 'amount': 100.00, 'duration_service': '30 min'}, {'id': '1', 'name': 'Troca de freios', 'amount': 150.00, 'duration_service': '40 min'}];
